...
public class ManageView_JPanel extends javax.swing.JPanel {
private AirplaneCatalog airplanecatalog;
private JPanel Display_JPanel;
    /**
     * Creates new form ManageView_JPanel
     */
    public ManageView_JPanel(JPanel Display_JPanel, AirplaneCatalog airplanecatalog) {
        initComponents();
    ...
    private void Delete_JButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Delete_JButtonActionPerformed
        ...
        if(selectedRow>=0){
            ...
            if(selectionResult == JOptionPane.YES_OPTION){
                Airplane a = (Airplane)View_JTable.getValueAt(selectedRow, 0);
                airplanecatalog.removeAirplane(a);
                populate();
            }
        }else{
    ...
    private void ViewDetails_JButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ViewDetails_JButtonActionPerformed
        ...
        if(SelectedRow>=0){
            ...
            ViewAirplane_JPanel vPanel=new ViewAirplane_JPanel(Display_JPanel,airplane,airplanecatalog);
